...
const Game = (props: { media1: Media, media2: Media, onSelectChoice: any, score: number }) => <>
    <div className="flex w-full h-full">
        ...
        <div className="flex flex-col items-center justify-center w-1/2 h-full bg-gradient-to-b from-yellow-400 via-red-500 to-pink-500">
            ...
            type={props.media1.type} 
            onClick={() => props.onSelectChoice(props.media1.id, props.media2.id)} 
            id={props.media1.id} 
            />
        </div>
        <div className="flex flex-col items-center justify-center w-1/2 h-full bg-gradient-to-t from-yellow-400 via-red-500 to-pink-500">
            <MediaBoard
                ...
                type={props.media2.type}
                onClick={() => props.onSelectChoice(props.media2.id, props.media1.id)}
                id={props.media2.id}
            />
        </div>
